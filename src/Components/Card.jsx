  ...
  let dispatch = useDispatch()
    return(
        <div className='w-[280px] h-[350px]  p-3 bg-white rounded-lg shadow-md flex flex-col gap-3 hover:border-2 border-green-300 transition-transform'>
         ...
         <button className='cursor-pointer w-full p-3 font-semibold text-white rounded-lg bg-green-500 hover:bg-green-400 transition-all' onClick={()=>dispatch(AddItems({id:id,name:name,price:price,image:image,qty:1}))}>Add To dish</button>
        </div>
    )
}
